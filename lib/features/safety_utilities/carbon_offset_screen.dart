...
class CarbonOffsetScreen extends StatelessWidget {
  const CarbonOffsetScreen({super.key});
    ...
    return GradientBackground(
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Colors.transparent,
          elevation: 0,
          title: Text('Carbon Offset', style: AppTextStyles.titleMedium.copyWith(color: AppColors.textPrimary)),
          leading: IconButton(
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text('Welcome to Carbon Offset', style: AppTextStyles.bodySmall.copyWith(color: AppColors.textSecondary)),
                      ],
                    ),
                  ),
                ],
